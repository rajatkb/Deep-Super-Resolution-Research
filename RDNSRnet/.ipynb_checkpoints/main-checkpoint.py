...
class SRResnet:
    ...
    def __init__(self , channel = 3 , lr=0.0001 , patch_size=32 , RDB_count=20):
            self.channel_axis = 3
...
for i in range(chk+1,tryout):
    ...
    net.fit(DATA.training_patches_2x[samplev] , DATA.training_patches_Y[samplev] , batch_size , epochs )
